...
| V~slv/cgh~ | mL | Volume of saliva expelled per cough | |  | |
| N~cgh/min~ |min^-1^ | Number of caughs per minute  | 0.57(1)| Normal |@Leung2020, based on data of 17 individuals with seasonal CoV| 
|t~i~ | min |Time spend doing the activity *i* | [...] | Normal | This study. Activity ATM: 20 hours of observational data |
|x~i~| m | Inoculation distance for activity *i* | [...] | Point values | Assumed |
| k | PFU^-1^ | Parameter of the exponential dose-response| 0.00246(0.00098) | Normal | http://qmrawiki.org/experiments/sars |
| n | min~-1~ |Decay rate for surface *j*| [...] | Normal | @VanDoremalen2020, CoV-2 infectivity assays, 40% RH and 21-23°C |
| |  ||  | | |
