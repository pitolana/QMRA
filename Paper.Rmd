...
where $C(t)$ [virus/cm^2^] is the concentration of virus in the surface, $TE_{sh}$[%] is the transfer efficiency of viruses between surfaces and hands, and $A_f$[cm^2^] is the area of the finger. For multiple touch scenarios the number of virus in the finger multiple contacts was calculated as follows: 
...
|$t_{btw-btn}$ | min |Time between pressing button | 0.5-20 | Uniform | Assumed |
...
*ATM Article* High level of microbiological contamination has been detected in ATM machines. The study highligths ATM machines as potential areas for pathogen accumulation [@Allemailem2020].

"The new coronavirus SARS-CoV-2 is less deadly but far more transmissible than MERS-CoV or SARS-CoV" [Petersen2020]

"The median duration of virus in the respiratory samples of patients with severe disease (21 days, 14-30 days) was significantly longer than in patients with mild disease (14 days, 10-21 days; P=0.04)" [@Zheng2020]
