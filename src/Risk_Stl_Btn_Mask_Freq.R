...
for (p in 1:simNum) {
    ...
    daily_risk$Loading1 <- ifelse(daily_risk$prevalence, df_stl_btn$load_surf[p], 0)
    daily_risk$Loading <- ifelse(daily_risk$compliance, daily_risk$Loading1 * (1-mask[p]), daily_risk$Loading1)
